...
<section class="main-content">
    <div class="wrapper">
            ...
            <div class="img-container">
                ...
                <div id="jumboText"class="jumbo_text">
                    <p>Roma</p>
                </div> 
            </div>
            ...
            <div class="send-message">
                <h3>Send a message for more informations </h3><i class="fas fa-arrow-right fa-2x"></i><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap"><i class="far fa-envelope fa-2x"></i></button>
            </div>
